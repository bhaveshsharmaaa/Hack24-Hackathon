...
export async function uploadProfilePicture(token, pfp) {
  ...
  try {
    ...
    toast.success("Click on save button to update the image");
...
export async function updateUserProfileAdditonal(
  token,
  dispatch,
  additionalDetails
) {
...
//deleteAccount
export async function deleteUserAccount(token, dispatch, navigate) {
